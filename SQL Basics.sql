...
SELECT CONCAT(au_fname, " ", au_lname) AS au_name
FROM authors;
...
-- 13. Select all books from the table titles that contains the word "cooking"
SELECT *
FROM titles
